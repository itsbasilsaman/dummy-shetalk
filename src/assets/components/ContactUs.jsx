...
import Image from '../New folder/17.png'
            ...
            <div className="container-default contact w-container">
              <div className="contact-wrapper">
                <div className="split-content contact-left">
                  ...
                  <div data-w-id="a0f1d516-e0b1-a799-88bd-d91e26250c22" style={{WebkitTransform: 'translate3d(0, 80px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 80px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 80px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 80px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', }} className="w-layout-grid contact-links-grid"><a href="mailto:contact@appflyx.com" className="card contact-link w-inline-block">
                      <div className="image-wrapper contact-link-icon"><img src="https://cdn.prod.website-files.com/60b0fc1ddfea6980daf21a18/60b7b8e2e9543752d84d79ed_icon-1-contact-links-app-x-template.svg" alt="Email Icon - App X Webflow Template" className="image contact-link-icon" /></div>
                      <div className="contact-link-content">
                        <div className="contact-link-title">Email us</div>
                        <div className="contact-link-text"> contact@she-talks.com
                        </div>
                      </div>
                    </a><a href="tel:(418)204-8701" className="card contact-link w-inline-block">
                      <div className="image-wrapper contact-link-icon"><img src="https://cdn.prod.website-files.com/60b0fc1ddfea6980daf21a18/60b7b8e2900950070f94dd97_icon-2-contact-links-app-x-template.svg" alt="Phone Icon - App X Webflow Template" className="image contact-link-icon" /></div>
                      <div className="contact-link-content">
                        <div className="contact-link-title">Call us</div>
                        <div className="contact-link-text">9004114517</div>
                      </div>
                    </a><a href="https://www.whatsapp.com/" target="_blank" className="card contact-link w-inline-block">
                      <div className="image-wrapper contact-link-icon"><img src="https://cdn.prod.website-files.com/60b0fc1ddfea6980daf21a18/60b7b8e381c466b140e55608_icon-3-contact-links-app-x-template.svg" alt="Messages - App X Webflow Template" className="image contact-link-icon" /></div>
                      <div className="contact-link-content">
                ...
                <div data-w-id="f628433d-0d2f-807e-5569-a9818ece717e" style={{WebkitTransform: 'translate3d(0, 80px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 80px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 80px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 80px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)',  }} className="card contact">
                  <div className="contact-form-block w-form">
                    <form id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form" method="get" className="contact-form" data-wf-page-id="60b7ab40d1620721e6ba1b9f" data-wf-element-id="1fea3553-cc35-955c-9c78-728d834b9e9c">
                      ...
                      <div className="input-wrapper"><label htmlFor="Phone-2">Subject</label><input className="input w-input" maxLength={256} name="Subject" data-name="Subject" placeholder="Ex. Support" type="tel" id="subject" required /></div>
                      <div id="w-node-b858b3c8-6167-2609-85d9-8c2ee908e624-e6ba1b9f" className="input-wrapper"><label htmlFor="Message">Message</label><textarea placeholder="Type your message here..." maxLength={5000} id="message" name="Message" data-name="Message" className="text-area w-input" defaultValue={""} /></div><input type="submit" data-wait="Please wait..." id="w-node-_1fea3553-cc35-955c-9c78-728d834b9ea3-e6ba1b9f" className="button-primary large contact-form-button w-button" defaultValue="Send message" />
                    </form>
