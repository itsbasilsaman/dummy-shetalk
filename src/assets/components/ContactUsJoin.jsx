  ...
  return (
    <div>
      <div className="w-full sm:px-[40px] px-[25px] pb-[30px] pt-[20px] sm:pt-[0px] flex items-center flex-col">
                  <h1  className="title contact" style={{textAlign: 'center'}}><span style={{color:'#da1c5c'}}>Join as </span>Trainer
                  </h1>
                  <p   className="paragraph contact sm:px-[10px] text-justify sm:text-center sm:w-[820px]"  >
